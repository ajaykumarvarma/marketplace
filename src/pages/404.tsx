    ...
    <>
      ...
      <main className="relative min-h-screen overflow-hidden flex items-center justify-center">
        ...
        <div className="relative text-center px-4">
          <div className="bg-card border border-border rounded-2xl p-10 md:p-14 shadow-card-hover max-w-md mx-auto">
            <div className="relative inline-flex items-center justify-center mb-6">
              ...
              <span className="absolute -top-2 -right-2 font-mono text-xs bg-red-500/10 border border-red-500/20 text-red-400 px-2 py-0.5 rounded">
                ERR_404
              </span>
            </div>
            <div className="mb-6">
            ...
            <div className="flex items-center justify-center gap-3">
              <Button variant="outline" className="gap-2 border-border hover:border-primary/30 hover:bg-primary/5" asChild>
                <Link href="/">
