    ...
    <>
      ...
      <div className="container py-12 md:py-20 space-y-16">
        <div className="text-center space-y-4">
          ...
          <h1 className="font-display text-4xl md:text-5xl font-bold text-foreground">Security Infrastructure</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <div key={f.title} className="bg-card border border-border rounded-lg p-6 space-y-3">
        ...
        <div className="bg-card border border-border rounded-lg p-8 space-y-6">
          <h2 className="font-display text-2xl font-bold text-foreground">Live Protection Metrics</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <div key={m.label} className="space-y-1">
                <p className="text-2xl font-mono font-bold text-foreground">{m.value}</p>
        ...
        <div className="space-y-4">
          <h2 className="font-display text-2xl font-bold text-foreground">Security Certifications</h2>
