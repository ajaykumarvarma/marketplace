      ...
      <div className="container py-12">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-foreground/70">Build on top of TradeVault with our REST API and webhooks.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Link href="/developer/api-keys" className="border border-border rounded-lg bg-card p-6 hover:border-primary/30 transition-colors">
              ...
              <p className="text-sm text-foreground/70 mb-3">Generate and manage API keys for authentication.</p>
            ...
            <Link href="/developer/webhooks" className="border border-border rounded-lg bg-card p-6 hover:border-primary/30 transition-colors">
              ...
              <p className="text-sm text-foreground/70 mb-3">Subscribe to real-time platform events.</p>
              ...
              <div className="space-y-3 text-sm">
                <div className="flex items-start gap-3 p-3 bg-muted rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/50 text-xs mt-0.5">List all products with pagination and filters.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 p-3 bg-muted rounded-lg">
                  <span className="text-xs font-mono px-2 py-0.5 rounded bg-success/10 text-success">GET</span>
                  <div>
                    ...
                    <p className="text-foreground/50 text-xs mt-0.5">Get detailed product information.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 p-3 bg-muted rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/50 text-xs mt-0.5">Create a new order (requires authentication).</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 p-3 bg-muted rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/50 text-xs mt-0.5">Get order status and details.</p>
                  </div>
                </div>
              </div>
              <p className="text-xs text-foreground/50 mt-3">Rate limit: 100 requests per minute per API key.</p>
            </div>
          </div>
        </div>
      </div>
