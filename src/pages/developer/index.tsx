      ...
      <div className="container py-12">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Link href="/developer/api-keys" className="border border-border rounded-lg bg-card p-6 hover:border-border transition-colors">
              ...
              <span className="text-sm text-foreground flex items-center gap-1">Manage Keys <ArrowRight className="h-4 w-4" /></span>
            </Link>

            <Link href="/developer/webhooks" className="border border-border rounded-lg bg-card p-6 hover:border-border transition-colors">
              ...
              <span className="text-sm text-foreground flex items-center gap-1">Manage Webhooks <ArrowRight className="h-4 w-4" /></span>
            </Link>
            ...
            <div className="border border-border rounded-lg bg-card p-6 md:col-span-2">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex items-start gap-3 p-3 bg-muted rounded-lg">
                  <span className="text-xs font-mono px-2 py-0.5 rounded bg-muted text-foreground border border-border">GET</span>
                  <div>
                ...
                <div className="flex items-start gap-3 p-3 bg-muted rounded-lg">
                  <span className="text-xs font-mono px-2 py-0.5 rounded bg-muted text-foreground border border-border">POST</span>
                  <div>
